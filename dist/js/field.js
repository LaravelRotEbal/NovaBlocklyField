...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-BlocklyField', __webpack_require__(3));
  Vue.component('detail-BlocklyField', __webpack_require__(6));
  Vue.component('form-BlocklyField', __webpack_require__(9));
});
